...
/**
 * Middleware for check if user is anonymous, if not redirect to home
 * @returns {Function}
 */
module.exports.anonymousAuth = () => (req, res, next) => {
...
/**
 * Middleware for check if user is logged, if not throw error
 * @returns {Function}
 */
